package com.easemob.im.server.api.chatrooms.member.list;
...
public class ListRoomMembers {
    ...
    public static Flux<String> all(Context context, String roomId, int limit) {
        return next(context, roomId, limit, null)
                ...
                .concatMapIterable(ListRoomMembersResponse::getMembers);
    }

    public static Mono<ListRoomMembersResponse> next(Context context, String roomId, int limit, String cursor) {
