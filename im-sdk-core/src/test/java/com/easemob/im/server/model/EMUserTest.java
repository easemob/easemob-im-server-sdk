...
public class EMUserTest {
    ...
    public void testUsernameValidate() {
        ...
        assertThrows(EMInvalidArgumentException.class, () -> EMUser
                .validateUsername("000000000000000000000000000000000")); // too long, 32 bytes max
        assertThrows(EMInvalidArgumentException.class,
                () -> EMUser.validateUsername("USR00001")); // invalid character
    }
    ...
    public void testPasswordValidate() {
        ...
        assertThrows(EMInvalidArgumentException.class,
                () -> EMUser.validatePassword("\"")); // invalid character
        assertThrows(EMInvalidArgumentException.class,
                () -> EMUser.validatePassword("\\")); // invalid character
        assertThrows(EMInvalidArgumentException.class,
                () -> EMUser.validatePassword("'")); // invalid character
