...
import com.easemob.im.agora.AccessToken2;
...
import com.easemob.im.auth.Authentication;
import com.easemob.im.auth.HttpBasicAuth;
import com.easemob.im.auth.ApiKeyAuth;
...
public class ApiClient {
    ...
    public ApiClient(String basePath, Realm realm, String appKey, String clientId, String clientSecret, String appId, String appCert, int maxIdleConnections, int connectKeepAliveMilliSeconds,
        ...
        this.servers = Collections.singletonList(
                new ServerConfiguration(
                        String.format("%s/%s/%s", basePath, this.appKey.split("#")[0],
                                this.appKey.split("#")[1]),
    ...
    private void initHttpClient(List<Interceptor> interceptors, int maxIdleConnections,
        ...
        if (emProxy != null) {
            if (emProxy.getIp() != null && emProxy.getPort() != 0) {
                Proxy proxy = new Proxy(Proxy.Type.HTTP, new InetSocketAddress(emProxy.getIp(), emProxy.getPort()));
                builder.proxy(proxy);
            }

            if (emProxy.getUsername() != null && emProxy.getPassword() != null) {
                Authenticator authenticator = (route, response) -> {
                    String credential = Credentials.basic(emProxy.getUsername(), emProxy.getPassword());
    ...
    private void init() throws ApiException {
        ...
        setUserAgent(String.format("Easemob-ServerSDK2.0_Java_%s", version));

        appTokenCache = CacheBuilder.newBuilder().maximumSize(1).expireAfterWrite(43200, TimeUnit.SECONDS).build();

        setAuthorizationToken(getAppToken());
        ...
        try {
            if (this.realm.equals(Realm.EASEMOB_REALM)) {
                return appTokenCache.get("app-token", () -> {
                    EMCreateToken createAppToken = new EMCreateToken();
                    createAppToken.setGrantType("client_credentials");
                    createAppToken.setClientId(this.clientId);
                    createAppToken.setClientSecret(this.clientSecret);
                    Map appTokenObj = (Map)createAppToken(createAppToken);
                    return (String) appTokenObj.get("access_token");
                });
            } else {
                return appTokenCache.get("agora-app-token", () -> {
                    return generateAgoraAppToken();
                });
            }
        } catch (Exception e) {
            throw new ApiException("get app token from cache error : " + e.getMessage());
        }
    }
    ...
    public okhttp3.Call createAppTokenCall(EMCreateToken createAppToken, final ApiCallback _callback) throws ApiException {
        ...
        String baseURL = servers.get(serverIndex).URL(serverVariables);
        ...
        Request request = buildAppTokenRequest(baseURL, localVarPath, "POST", localVarQueryParams, localVarCollectionQueryParams, localVarPostBody, localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAuthNames, _callback);

        return httpClient.newCall(request);
    }

    @SuppressWarnings("rawtypes")
    private okhttp3.Call createAppTokenValidateBeforeCall(EMCreateToken createAppToken, final ApiCallback _callback) throws ApiException {
        return createAppTokenCall(createAppToken, _callback);
    ...
    public ApiResponse<Object> createAppTokenWithHttpInfo(EMCreateToken createAppToken) throws ApiException {
        ...
        return execute(localVarCall, localVarReturnType);
    }

    private String generateAgoraAppToken() {
        AccessToken2 accessToken = new AccessToken2(appId, appCert, 86400);
        ...
        try {
            ...
            throw new IllegalArgumentException("building agora app token failed");
        }
    }
    ...
    public static class Builder {
        ...
        private int connectKeepAliveMilliSeconds = 10000;
        ...
        public Builder setAppKey(String appKey) {
            ...
            if (tokens.length != 2) {
                throw new IllegalArgumentException("appKey must contains #");
            }
            if (tokens[0].isEmpty()) {
                throw new IllegalArgumentException("appKey must contains {org}");
            }
            if (tokens[1].isEmpty()) {
                throw new IllegalArgumentException("appKey must contains {app}");
            }
            this.appKey = appKey;
            return this;
        }
        ...
        public Builder setAppCert(String appCert) {
            if (StringUtils.isBlank(appCert)) {
                throw new IllegalArgumentException("appCert must not be null or blank");
            }
            this.appCert = appCert;
            return this;
        }
        ...
        public Builder setMaxIdleConnections(int maxIdleConnections) {
            if (maxIdleConnections < 0) {
                throw new IllegalArgumentException("maxIdleConnections must not be negative");
            }
            this.maxIdleConnections = maxIdleConnections;
            return this;
        }

        public Builder setConnectKeepAliveMilliSeconds(int connectKeepAliveMilliSeconds) {
            if (connectKeepAliveMilliSeconds < 0) {
                throw new IllegalArgumentException("connectKeepAliveMilliSeconds must not be negative");
            }
            this.connectKeepAliveMilliSeconds = connectKeepAliveMilliSeconds;
            return this;
        }

        public Builder setConnectTimeoutMilliSeconds(int connectTimeoutMilliSeconds) {
            if (connectTimeoutMilliSeconds < 0) {
                throw new IllegalArgumentException("connectTimeoutMilliSeconds must not be negative");
            }
        ...
        public ApiClient build() throws ApiException {
            if (StringUtils.isBlank(basePath)) {
                throw new IllegalArgumentException("basePath must not be null");
            }
            ...
            if (this.realm.equals(Realm.EASEMOB_REALM)) {
                ...
                if (this.clientSecret == null) {
                    throw new IllegalArgumentException("clientSecret not set");
                }
                if (this.appId != null || this.appCert != null) {
                    throw new IllegalArgumentException("appId and appCert must be blank");
                }
                ...
                if (this.appCert == null) {
                    throw new IllegalArgumentException("appCert not set");
                }
                if (this.clientId != null || this.clientSecret != null) {
                    throw new IllegalArgumentException("clientId and clientSecret must be blank");
                }
        ...
        public static class Builder {
            ...
            public Builder setPort(int port) {
                if (port < 0 || port > 65535) {
                    throw new IllegalArgumentException(String.format("port %s is illegal", port));
                }
                this.port = port;
                return this;
            }
    ...
    public ApiClient setAuthorizationToken(String appToken) {
        addDefaultHeader("Authorization", String.format("Bearer %s", appToken));
        return this;
    }
    ...
    public Request buildRequest(String baseUrl, String path, String method, List<Pair> queryParams, List<Pair> collectionQueryParams, Object body, Map<String, String> headerParams, Map<String, String> cookieParams, Map<String, Object> formParams, String[] authNames, ApiCallback callback) throws ApiException {
        ...
        headerParams.put("Authorization", String.format("Bearer %s", getAppToken()));
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public Request buildAppTokenRequest(String baseUrl, String path, String method, List<Pair> queryParams, List<Pair> collectionQueryParams, Object body, Map<String, String> headerParams, Map<String, String> cookieParams, Map<String, Object> formParams, String[] authNames, ApiCallback callback) throws ApiException {
        // aggregate queryParams (non-collection) and collectionQueryParams into allQueryParams
        List<Pair> allQueryParams = new ArrayList<Pair>(queryParams);
        allQueryParams.addAll(collectionQueryParams);
