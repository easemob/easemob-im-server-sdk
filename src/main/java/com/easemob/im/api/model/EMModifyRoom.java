 ...
 * EMModifyRoom
 */
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-04-02T19:03:46.433433+08:00[Asia/Shanghai]", comments = "Generator version: 7.14.0")
public class EMModifyRoom {
    ...
    public EMModifyRoom name(@javax.annotation.Nullable String name) {
        this.name = name;
        return this;
    }
    ...
    public EMModifyRoom description(@javax.annotation.Nullable String description) {
    ...
    public EMModifyRoom maxusers(@javax.annotation.Nullable Integer maxusers) {
    ...
    public void setMaxusers(@javax.annotation.Nullable Integer maxusers) {
        this.maxusers = maxusers;
    }


    public EMModifyRoom newowner(@javax.annotation.Nullable String newowner) {
    ...
    public void setNewowner(@javax.annotation.Nullable String newowner) {
        this.newowner = newowner;
    }
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.name, modifyRoom.name) &&
                ...
                Objects.equals(this.newowner, modifyRoom.newowner);
    }

    @Override
    public int hashCode() {
        return Objects.hash(name, description, maxusers, newowner);
    }
    ...
    static {
        ...
        openapiFields = new HashSet<String>(Arrays.asList("name", "description", "maxusers", "newowner"));
