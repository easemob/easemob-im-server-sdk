...
public class EMCreateRoom {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.groupid, createRoom.groupid) &&
                Objects.equals(this.name, createRoom.name) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(groupid, name, description, maxusers, owner, members, custom);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!EMCreateRoom.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(String.format(
                        "The required field(s) %s in EMCreateRoom is not found in the empty JSON string",
                        EMCreateRoom.openapiRequiredFields.toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!EMCreateRoom.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(String.format(
                        "The field `%s` in the JSON string is not defined in the `EMCreateRoom` properties. JSON: %s",
