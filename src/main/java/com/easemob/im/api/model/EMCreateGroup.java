...
public class EMCreateGroup {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.groupname, createGroup.groupname) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(groupname, description, _public, scale, maxusers, allowinvites, membersonly, inviteNeedConfirm, owner, members, custom);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EMCreateGroup.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EMCreateGroup is not found in the empty JSON string", EMCreateGroup.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EMCreateGroup.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EMCreateGroup` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
