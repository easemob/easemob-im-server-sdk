...
public class EMUserCollectionGetResult {
    ...
    public EMUserCollectionGetResult() {}
    ...
    public boolean equals(Object o) {
        ...
        EMUserCollectionGetResult that = (EMUserCollectionGetResult) o;
    ...
    public String toString() {
        return "class EMUserCollectionGetResult {\n" +
